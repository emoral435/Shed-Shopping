...
export default function Cart(props: cartProps) {
    return (
        <motion.span whileHover={{ rotate: 360}} transition={{duration: .7}} className='relative flex justify-center items-center w-16 h-16 bg-[#ffcd3e] rounded-[50%] cursor-pointer'>
