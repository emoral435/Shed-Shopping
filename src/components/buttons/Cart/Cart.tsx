...
export default function Cart(props: cartProps) {
    return (
        <motion.span whileHover={{ rotate: 360}} transition={{duration: .7}} className='relative flex justify-center items-center w-14 h-14 mr-8 bg-[#ffcd3e] rounded-[50%] cursor-pointer'>
